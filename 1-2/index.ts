...
const decodedValues = codedValues.map((code) => {


    code = resolveWordsToInteger(code);
    ...
    let decodedNumber = firstDigit + lastDigit;

    return parseInt(decodedNumber)
})

// console.log(decodedValues)
console.log('Length', decodedValues.length)

const sumOfDecodedValues = decodedValues.reduce((code, acc) => code + acc, 0)
console.log(sumOfDecodedValues)